...
The max number of steps per interval accross all days is `r maxSteps` at interval # `r maxInterval`.    
...
After filling missing data, the mean number of steps changed from `r meanSteps` to  `r meanSteps2`.      

The median number of steps changed from `r medianSteps` to `r medianSteps2`.  
